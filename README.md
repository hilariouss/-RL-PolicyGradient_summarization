...
하지만, off-policy 알고리즘은 *target policy*와 *behaviour policy*가 달라, 현재 학습하는 *estimation policy*가 과거에 했던 experience도 학습에 사용할 수 있다는 장점이 있습니다. 이는 sample efficiency를 향상시켜 학습의 효율성을 높일 수 있는 요인이 .
